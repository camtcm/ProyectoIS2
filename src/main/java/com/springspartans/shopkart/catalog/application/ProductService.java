...
public class ProductService {
    ...
    public void addProduct(int id, ProductDetails details, MultipartFile image)
        ...
        Product product = new Product(id, new ProductDetails(details.getName(), details.getCategory(),
                details.getBrand(), details.getPrice(), imageName, details.getStock(), details.getDiscount()));
