...
public class CartItemController {
    ...
    // CONSTANTE CENTRALIZADA PARA ELIMINAR EL CODE SMELL
    private static final String REDIRECT_TO_CART = "redirect:/cartitem/cart";
    ...
    public String incrementQuantity(@PathVariable int slno, RedirectAttributes redirectAttributes) {
        ...
        return REDIRECT_TO_CART; // Refactorizado
    }
